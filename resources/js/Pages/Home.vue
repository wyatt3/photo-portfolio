    ...
    <main class="top-spacing">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4">
        ...
        >
          ...
          <div
            class="absolute inset-0 bg-gradient-to-t from-neutral-950/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          />

          <div
            class="absolute top-3 right-3 flex flex-wrap gap-1.5 justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-75"
          >
            <span
          ...
          <div
            class="absolute bottom-3 right-3 flex items-center gap-2 text-white/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100"
          >
            <span
              class="flex items-center gap-1.5 text-sm font-light bg-white/10 backdrop-blur-md px-2.5 py-1 rounded-full"
            >
